            ...
            <div className='SProject-photo-Name-div'>
                <div className='SProject-photo-div'>
                    ...
                    {data?.photos?.map((el, i) => {
                        let photo = "https://drive.google.com/uc?id=" + el?.replace("https://drive.google.com/file/d/", "").replace("/view?usp=share_link", "")
                        return (
                            <img id={"media" + i} className="SPMedia" key={i} src={photo} alt="p" />
                        )
                    })}
